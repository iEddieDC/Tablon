<!--Este header es para todo lo demas-->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid"><a class="navbar-brand" href="<?php echo SERVERURL?>">
                ...
                <button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    ...
                    <?php if (isset($_SESSION['user'])){?>
                        <a class=" btn btn-light login" href="<?php echo SERVERURL?>logout">Cerrar sesión</a>
                    <?php }else{ ?>
                        <a class="btn btn-light action-button" role="button" href="<?php echo SERVERURL?>login">Iniciar sesión</a>
                    </span>
                    <?php }?>
                </div>
            </div>
